...
public class Authenticator {
     ...
     */
    private static HashMap<String, Int> Employees = new HashMap<>();
    /*
     * PATIENT HASHMAP
     * Key: Patient email
     * Value: Patient password
     */
    private static HashMap<String, Int> Patients = new HashMap<>();
    ...
    public boolean AuthenticateEmployee(String employee_id, String password){
        ...
        String hashed_pass = password.hashCode();
        if(!Employees.exists(employee_id)) return false;
        if(Employees[employee_id] == hashed_pass) return true;
        return false;
    }
    ...
    public boolean AuthenticatePatient(String patient_id, String password){
        // Implementation details... 
        int hashed_pass = password.hashCode();
        if(!Patients.exists(patient_id)) return false;
        if(Patients[patient_id] == hashed_pass) return true;
        return false;       
    }
    ...
    public Boolean addNewEmployee(String employee_id, String password){
        // Implementation details... 
        if(Employees.exists(employee_id)) return false;
        Employees.put(employee_id, password.hashCode());
        return true;
    }
    ...
    public Boolean addNewPatient(String patient_id, String password){
        // Implementation details... 
        if(Patients.exists(patient_id)) return false;
        Patients.put(patient_id, password.hashCode());
        return true;
    }
    ...
    public Boolean employeeExists(String employee_id){
        //Implementation details...
        return Employees.exists(employee_id);
    }
    ...
    public Boolean patientExists(String patient_id){
        //Implementation details...
        return Patients.exists(patient_id);
    }
}
