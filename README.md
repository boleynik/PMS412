for the assignment due Feb 18, all we need to do is create the classes required for our 5 use cases (no minimum, but we need to represent the entire system) 
